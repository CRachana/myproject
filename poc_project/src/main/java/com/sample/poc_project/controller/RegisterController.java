...
import com.sample.poc_project.service.EmailService;
//import com.spring.bioMedical.entity.ConfirmationToken;
...
//ConfirmationToken confirmationToken = new ConfirmationToken(user);
			...
			//confirmationToken.save(confirmationToken);
		...
		//	String appUrl = request.getScheme() + "://" + request.getServerName();
		   ...
		   String appUrl = "http://localhost:8080";
			...
			registrationEmail.setFrom("dharsannew@gmail.com");
	...
	// Process confirmation link	@RequestMapping(value="/confirm", method = RequestMethod.POST)
